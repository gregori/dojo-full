...
def check_in_tablet(event_id: str, check_in_data: CheckInRequest, request: Request, db: Session = Depends(get_db)):
...
def check_in_qr(check_in_data: CheckInQRRequest, request: Request, db: Session = Depends(get_db)):
...
def delete_attendance(
    attendance_id: str, db: Session = Depends(get_db), current_user=Depends(get_current_instructor_or_admin)
):
