...
from app.schemas import (
    ExamCreate, ExamUpdate, ExamResponse, ExamWithDetails,
    ExamParticipantCreate, ExamParticipantUpdate, ExamParticipantResponse,
    ExamBoardMemberCreate, ExamBoardMemberResponse,
)
...
def promote_candidate(
    ...
    return ExamService.promote_candidate(
        db, participant_id, new_belt_id, promoted_by=current_user.id
    )
