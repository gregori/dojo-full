...
## Phase 1: Pré-Checkin
**Goal:** Alunos confirmam presença antecipada para aulas, e instrutores vêem lista de confirmados para decidir se mantêm ou cancelam o treino.
...
**UI hint:** yes — Confirmation interface, instructor dashboard with attendee list, cancel/confirm toggle
...
|---|-------|------|--------------|------------------|
| 1 | Pré-Checkin | Confirmação antecipada de presença | 5 (PRE-01 to PRE-05) | 4 |
