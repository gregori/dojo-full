...
- Phase 2 is planned and decision-gated to completion. Use `squad-feature` to build PR-2 against the acceptance criteria in `.workflow/runs/epic-02-plan/plan.md`'s "Phase 2 Implementation Plan" section.
